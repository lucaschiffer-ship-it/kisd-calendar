...
class _MealRow extends StatelessWidget {
  ...
  static const _veganColor = Color(0xFF34C759);
  static const _vegColor = Color(0xFF34C759);
  static const _porkColor = Color(0xFFFF3B30);
  static const _beefColor = Color(0xFF8B4513);
  ...
  Widget build(BuildContext context) {
    ...
    return DecoratedBox(
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(
            color: tokens.AppThemeTokens.secondaryTextColor.withValues(alpha: 0.1),
            width: 0.5,
          ),
        ),
      ),
          ...
          children: [
            ...
            FilledButton.icon(
              ...
              style: FilledButton.styleFrom(
                backgroundColor: tokens.AppThemeTokens.eventAccent,
